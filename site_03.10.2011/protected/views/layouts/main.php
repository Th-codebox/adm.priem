...
<div class="left-menu">
  <div class="left-menu-b">
	...
	<?php if (Yii::app()->params['menu'][$this->getAction()->id]) $this->widget('zii.widgets.CMenu',array('items'=> Yii::app()->params['menu'][$this->getAction()->id])); ?>
...
<!--- COUNTERS ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::--->      
    ...
    <div class="copyrights">
      ...
      &copy; 2005-2011 &laquo;Администрация Петрозаводского городского округа&raquo;<br />Все права защищены. 
