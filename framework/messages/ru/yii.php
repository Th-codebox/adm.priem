...
return array (
  ...
  '{class} does not have attribute "{attribute}".' => 'Класс {class} не содержит свойства "{attribute}".',
  ...
  'CDbMessageSource.connectionID is invalid. Please make sure "{id}" refers to a valid database application component.' => 'Идентификатор CDbMessageSource.connectionID указан неверно. Удостоверьтесь, что "{id}" указывает на правильный компонент для работы с базой данных вашего приложения.',
  ...
  'CHttpSession.gcProbability "{value}" is invalid. It must be an integer between 0 and 100.' => 'Значение параметра CHttpSession.gcProbability "{value}" задано неверно. Необходимо указать целое число от 0 до 100.',
  ...
  'Invalid enumerable value "{value}". Please make sure it is among ({enum}).' => 'Неверно задано значение "{value}". Поддерживаются следующие значения ({enum}).',
  ...
  'The table "{table}" for active record class "{class}" cannot be found in the database.' => 'Таблица "{table}", используемая Active Record-классом "{class}", не найдена в базе данных.',
  ...
  '{attribute} "{value}" has already been taken.' => 'Значение "{value}" для поля {attribute}  уже существует.',
  '{attribute} cannot be blank.' => 'Поле "{attribute}" не может быть пустым.',
  '{attribute} is invalid.' => 'Поле "{attribute}" не корректно.',
  '{attribute} is not a valid URL.' => 'Поле "{attribute}" не является правильным URL.',
  '{attribute} is not a valid email address.' => 'Поле "{attribute}" не является правильным E-Mail адресом.',
  '{attribute} is not in the list.' => 'Поле "{attribute}" отсутствует в списке.',
  '{attribute} is of the wrong length (should be {length} characters).' => 'Поле "{attribute}" неверной длины (Должно быть {length} симв.).',
  '{attribute} is too big (maximum is {max}).' => 'Поле "{attribute}" слишком велико (Максимум: {max}).',
  '{attribute} is too long (maximum is {max} characters).' => 'Поле "{attribute}" слишком длинное (Максимум: {max} симв.).',
  '{attribute} is too short (minimum is {min} characters).' => 'Атрибут "{attribute}" слишком короткое (Минимум: {min} симв.).',
  '{attribute} is too small (minimum is {min}).' => 'Поле "{attribute}" слишком маленькое (Минимум: {min}).',
  '{attribute} must be a number.' => 'Поле "{attribute}" должно быть числом.',
  '{attribute} must be an integer.' => 'Поле "{attribute}" должно быть целым числом.',
  '{attribute} must be repeated exactly.' => 'Поле "{attribute}" должно быть повторено в точности.',
  '{attribute} must be {type}.' => 'Поле "{attribute}" должно быть {type}.',
  ...
  '{class} does not have attribute "{name}".' => 'Класс {class} не имеет свойства "{name}".',
  ...
  '{controller} contains improperly nested widget tags in its view "{view}". A {widget} widget does not have an endWidget() call.' => 'Контроллер {controller} содержит в своем представлении "{view}" тэги виджетов с неправильной вложенностью. В виджете (widget) {widget} не используется вызов endWidget().',
